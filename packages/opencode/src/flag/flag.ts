...
export namespace Flag {
  ...
  export declare const OPENCODE_DISABLE_CHANNEL_DB: boolean
...
Object.defineProperty(Flag, "OPENCODE_DISABLE_CHANNEL_DB", {
  get() {
    return truthy("OPENCODE_DISABLE_CHANNEL_DB")
  },
  enumerable: true,
  configurable: false,
})
