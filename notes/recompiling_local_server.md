...
## 2. Kill the Existing Backend Process
...
OPENCODE_SERVER_USERNAME=opencode OPENCODE_SERVER_PASSWORD=rohan123 nohup ~/.bun/bin/bun run --conditions=browser ./src/index.ts serve --port 5000 > backend.log 2>&1 &
```
